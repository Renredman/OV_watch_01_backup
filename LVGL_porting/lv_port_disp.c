...
void lv_port_disp_init(void)
{
    ...
    static lv_color_t buf_2_1[MY_DISP_HOR_RES * 40];                        /*A buffer for 60 rows - optimized for better performance*/
    static lv_color_t buf_2_2[MY_DISP_HOR_RES * 40];                        /*An other buffer for 60 rows*/
