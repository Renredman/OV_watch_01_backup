...
void setup_scr_game(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->game_btn_3_label, "Button");
    ...
    lv_obj_set_pos(ui->game_btn_3, 0, 101);
    ...
    lv_label_set_text(ui->game_btn_2_label, "Button");
    ...
    lv_obj_set_pos(ui->game_btn_2, 0, 51);
    ...
    lv_obj_set_pos(ui->game_label_1, 10, 12);
    ...
    lv_obj_set_pos(ui->game_label_3, 10, 105);
