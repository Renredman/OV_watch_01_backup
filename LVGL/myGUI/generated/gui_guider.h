...
typedef struct
{
	...
	lv_obj_t *settings;
	bool settings_del;
	lv_obj_t *settings_btn_5;
	lv_obj_t *settings_btn_5_label;
	...
	bool story_del;
	lv_obj_t *story_stor;
	lv_obj_t *story_stor_sidebar_page;
	lv_obj_t *story_stor_subpage_1;
	lv_obj_t *story_stor_cont_1;
	lv_obj_t *story_stor_label_1;
	lv_obj_t *story_stor_subpage_2;
	lv_obj_t *story_stor_cont_2;
	lv_obj_t *story_stor_label_2;
	lv_obj_t *story_stor_subpage_3;
	lv_obj_t *story_stor_cont_3;
	lv_obj_t *story_stor_label_3;
	lv_obj_t *story_list_1;
	lv_obj_t *story_list_1_item0;
	lv_obj_t *story_list_1_item1;
	lv_obj_t *story_list_1_item2;
	lv_obj_t *story_list_1_item3;
	lv_obj_t *story_list_1_item4;
	lv_obj_t *story_list_1_item5;
	lv_obj_t *story_list_1_item6;
	lv_obj_t *story_list_1_item7;
	lv_obj_t *story_list_1_item8;
	lv_obj_t *story_list_2;
	lv_obj_t *story_list_2_item0;
	lv_obj_t *story_list_2_item1;
	lv_obj_t *story_list_2_item2;
	lv_obj_t *story_list_2_item3;
	lv_obj_t *story_list_2_item4;
	lv_obj_t *story_list_2_item5;
	lv_obj_t *story_list_2_item6;
	lv_obj_t *story_list_2_item7;
	lv_obj_t *story_list_2_item8;
	lv_obj_t *story_list_2_item9;
	lv_obj_t *story_list_3;
	lv_obj_t *story_list_3_item0;
	lv_obj_t *story_list_3_item1;
	lv_obj_t *story_list_3_item2;
	lv_obj_t *story_list_3_item3;
	lv_obj_t *story_list_3_item4;
	lv_obj_t *story_list_3_item5;
	lv_obj_t *story_list_3_item6;
	...
	lv_obj_t *secret;
	bool secret_del;
	lv_obj_t *secret_btn_11;
	lv_obj_t *secret_btn_11_label;
	lv_obj_t *secret_btn_10;
	lv_obj_t *secret_btn_10_label;
	lv_obj_t *secret_btn_9;
	lv_obj_t *secret_btn_9_label;
	lv_obj_t *secret_btn_8;
	lv_obj_t *secret_btn_8_label;
	lv_obj_t *secret_btn_7;
	lv_obj_t *secret_btn_7_label;
	lv_obj_t *secret_btn_6;
	lv_obj_t *secret_btn_6_label;
	lv_obj_t *secret_btn_5;
	lv_obj_t *secret_btn_5_label;
	lv_obj_t *secret_btn_4;
	lv_obj_t *secret_btn_4_label;
	lv_obj_t *secret_btn_3;
	lv_obj_t *secret_btn_3_label;
	lv_obj_t *secret_btn_2;
	lv_obj_t *secret_btn_2_label;
	lv_obj_t *secret_btn_1;
	lv_obj_t *secret_btn_1_label;
	lv_obj_t *secret_label_13;
	lv_obj_t *secret_label_14;
	lv_obj_t *secret_label_15;
	lv_obj_t *secret_label_16;
	lv_obj_t *secret_change;
	bool secret_change_del;
	lv_obj_t *secret_change_roller_1;
	lv_obj_t *secret_change_roller_2;
	lv_obj_t *secret_change_roller_3;
	lv_obj_t *secret_change_roller_4;
	lv_obj_t *secret_change_btn_1;
	lv_obj_t *secret_change_btn_1_label;
	lv_obj_t *secret_change_btn_2;
	lv_obj_t *secret_change_btn_2_label;
	lv_obj_t *secret_change_btn_3;
	lv_obj_t *secret_change_btn_3_label;
	lv_obj_t *secret_change_msgbox_1;
	lv_obj_t *secret_change_msgbox_2;
	lv_obj_t *time_date;
	bool time_date_del;
	lv_obj_t *time_date_cont_6;
	lv_obj_t *time_date_btn_12;
	lv_obj_t *time_date_btn_12_label;
	lv_obj_t *time_date_btn_11;
	lv_obj_t *time_date_btn_11_label;
	lv_obj_t *time_date_label_12;
	lv_obj_t *time_date_label_11;
	lv_obj_t *time_date_cont_5;
	lv_obj_t *time_date_btn_10;
	lv_obj_t *time_date_btn_10_label;
	lv_obj_t *time_date_btn_9;
	lv_obj_t *time_date_btn_9_label;
	lv_obj_t *time_date_label_10;
	lv_obj_t *time_date_label_9;
	lv_obj_t *time_date_cont_4;
	lv_obj_t *time_date_btn_8;
	lv_obj_t *time_date_btn_8_label;
	lv_obj_t *time_date_btn_7;
	lv_obj_t *time_date_btn_7_label;
	lv_obj_t *time_date_label_8;
	lv_obj_t *time_date_label_7;
	lv_obj_t *time_date_cont_3;
	lv_obj_t *time_date_btn_6;
	lv_obj_t *time_date_btn_6_label;
	lv_obj_t *time_date_btn_5;
	lv_obj_t *time_date_btn_5_label;
	lv_obj_t *time_date_label_6;
	lv_obj_t *time_date_label_5;
	lv_obj_t *time_date_cont_2;
	lv_obj_t *time_date_btn_4;
	lv_obj_t *time_date_btn_4_label;
	lv_obj_t *time_date_btn_3;
	lv_obj_t *time_date_btn_3_label;
	lv_obj_t *time_date_label_4;
	lv_obj_t *time_date_label_3;
	lv_obj_t *time_date_cont_1;
	lv_obj_t *time_date_btn_1;
	lv_obj_t *time_date_btn_1_label;
	lv_obj_t *time_date_btn_2;
	lv_obj_t *time_date_btn_2_label;
	lv_obj_t *time_date_label_2;
	lv_obj_t *time_date_label_1;
	lv_obj_t *time_date_msgbox_1;
	lv_obj_t *compass;
	bool compass_del;
	lv_obj_t *compass_meter_1;
	lv_meter_scale_t *compass_meter_1_scale_0;
	lv_meter_indicator_t *compass_meter_1_scale_0_ndline_0;
	lv_obj_t *compass_label_1;
	lv_obj_t *compass_label_2;
	lv_obj_t *compass_label_3;
	lv_obj_t *compass_label_4;
...
LV_IMG_DECLARE(_pic_compass_pointer_alpha_90x150);
...
LV_FONT_DECLARE(lv_font_icomoon_48)
